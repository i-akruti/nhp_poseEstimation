...
if __name__ == '__main__':
    ...
    class Args():
        def __init__(self):
            ...
            # coco
            # self.labels = "../../coco_dataset/annotations_trainval2017/annotations/person_keypoints_val2017.json"
            # self.output_name = "/home/tanay/akruti/openpose_light_pytorch/prepared_dataset_coco/prepared_val_annotation.pkl"

            # monkey
            self.labels = "../../monkey_dataset/val_monkey2coco_v1.json"
            self.output_name = "../prepared_val_annotation.pkl"

            # test pipeline monkey
            # self.labels = "../../monkey_dataset/test_pipeline/annotation_cocoFormat_testpipeline/annotation_testpipeline_monkey2coco_train.json"
            # self.output_name = "../../prepared_dataset_monkey/test_pipeline/prepared_train_annotation.pkl"
            self.net_input_size = 368
