...
if __name__ == '__main__':
    ...
    class Args:
        def __init__(self):
            self.labels = "../../monkey_dataset/test_pipeline/annotation_cocoFormat_testpipeline/annotation_testpipeline_monkey2coco_val.json"
            self.output_name = "../../prepared_dataset_monkey/test_pipeline/prepared_val_annotation.json"
            self.num_images = 250
