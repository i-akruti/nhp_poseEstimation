...
class Pose:
    ...
    #              'r_eye', 'l_eye',
    #              'r_ear', 'l_ear']
    # monkey keypoint names
    kpt_names = ['r_eye', 'l_eye', 'nose', 'head',
                 'neck', 'r_sho', 'r_elb', 'r_wri', 'l_sho', 'l_elb', 'l_wri',
                 'hip', 'r_knee', 'r_ank', 'l_knee', 'l_ank',
                 'tail']
    # sigmas = np.array([.26, .79, .79, .72, .62, .79, .72, .62, 1.07, .87, .89, 1.07, .87, .89, .25, .25, .35, .35],
    #                   dtype=np.float32) / 10.0
    sigmas = np.array([.25, .25, .26, .79, .79, .79, .72, .62, .79, .72, .62, 1.07, 87, .89, 87, .89, 1.07],
                      dtype=np.float32) / 10.0
    vars = (sigmas * 2) ** 2
    last_id = -1
    color = [0, 224, 255]
